import {
  ...
  Keyboard, TouchableWithoutFeedback, KeyboardAvoidingView, Platform, ScrollView, Switch, Animated
} from 'react-native';
...
export default function AddEventScreen() {
  ...
  const initialDate = date ? new Date(date + 'T10:00:00') : new Date();
      ...
      <SafeAreaView style={s.container}>
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={s.inner}>
          <View style={s.header}>
            ...
            <Text style={s.headerTitle}>Nouvel evenement</Text>
            <AnimatedPressable onPress={handleCreate} disabled={loading} style={s.headerBtn}>
              <Text style={[s.headerSaveText, loading && s.headerBtnDisabled]}>
                {loading ? '...' : 'Creer'}
              </Text>
            </AnimatedPressable>
          </View>
